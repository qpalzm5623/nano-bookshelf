            ...
            <div class="card-body">
                ...
                <div class="row row-search">
                    ...
                    <div class="col-sm-8 row align-middle">
                            <input type="text" class="form-control col-8 float-right date hasDatepicker" style="margin:5px 5px 5px 5px;" name="keyword" id="keyword" value="<?php echo @$_GET['keyword']?>" placeholder="도서명을 입력해 주세요.">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr >
                        ...
                        <td class="text-center">{quiz_cnt}</td>
                        <td class="text-center">{worksheet}</td>
                        <td class="text-center">{quiz_use_cnt}</td>
                        <td class="text-center">{reg_date}
                        ...
                        <input type="hidden" id="quiz_cnt{count}" value="{quiz_cnt}" />
                        <input type="hidden" id="quiz_use_cnt{count}" value="{quiz_use_cnt}" />
                        <input type="hidden" id="reg_date{count}" value="{reg_date}" />
                        <input type="hidden" id="worksheet{count}" value="{worksheet}" />
...
function choice() {
    $("input[name='check[]']:checked").each(function(){
       ...
       if(opener.isFind($('#quiz_seq'+seq).val()) == false) {
           opener.book_info_list.push(data);
           
           opener.book_list.push($('#quiz_seq'+seq).val());
           var html = '<tr style="cursor:pointer;height:20px" class="book_'+$('#book_no'+seq).val()+'">';
           html += '  <td class="text-center align-middle" style="height:20px"><input type="hidden" name="quiz_seq[]" value="'+$('#quiz_seq'+seq).val()+'"><input type="hidden" name="book_no[]" value="'+$('#book_no'+seq).val()+'">'+$('#book_name'+seq).val()+'</td>';
           ...
           html += '  <td class="text-center align-middle">'+$('#quiz_cnt'+seq).val()+'</td>';
           html += '  <td class="text-center align-middle">'+$('#worksheet'+seq).val()+'</td>';
           html += '  <td class="text-center align-middle">'+$('#quiz_use_cnt'+seq).val()+'</td>';
           html += '  <td class="text-center align-middle">'+$('#reg_date'+seq).val()+'</td>';
