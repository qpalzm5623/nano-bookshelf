      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form role="form" id="mainBannerModifyForm" enctype="multipart/form-data" action="{base_url}admin/mainBannerModiProc" method="POST">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <label style="margin-left:5px; margin-top:5px;">
                          <input type="radio" name="language" value="kor" <?php echo ($bannerData['language']=="kor") ? "checked" : "" ?>/> 한국어
                        </label>
                        <label style="margin-left:5px; margin-top:5px;">
                          <input type="radio" name="language" value="eng" <?php echo ($bannerData['language']=="eng") ? "checked" : "" ?>/> 영어
                        </label>
                        <label style="margin-left:5px; margin-top:5px;">
                          <input type="radio" name="language" value="chn" <?php echo ($bannerData['language']=="chn") ? "checked" : "" ?>/> 중국어
                        </label>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <label style="margin-left:5px; margin-top:5px;">
                          <input type="radio" name="view_location" value="top" <?php echo ($bannerData['view_location']=="top") ? "checked" : "" ?>/> 상단배너
                        </label>
                        <label style="margin-left:5px; margin-top:5px;">
                          <input type="radio" name="view_location" value="new" <?php echo ($bannerData['view_location']=="new") ? "checked" : "" ?>/> NEW PRODUCT
                        </label>
                      </td>
                    </tr>                    
                    <tr>
                      ...
                      <td>
                        <input type="text" class="form-control col-sm-4 float-left" name="b_title" id="b_title" value="<?php echo $bannerData['b_title']; ?>"/>
                      </td>
                    </tr>
                    <tr>
                      <th>설명글</th>
                      <td>
                        <input type="text" class="form-control col-sm-4 float-left" name="b_description" id="b_description" value="<?php echo $bannerData['b_description']; ?>"/>
                      </td>
                    </tr>
                    <tr class="top_tr">
                      <th><small style="color:red">*</small> 게시기간</th>
                      <td style="vertical-align:middle;">
                        <input type="text" class="form-control col-sm-1 date float-left" name="b_start_date" id="b_start_date" placeholder="yyyy-mm-dd" value="<?php echo date("Y-m-d",strtotime($bannerData['b_start_date'])); ?>"/>
                        <select class="form-control col-sm-1 float-left" style="margin-left:5px; margin-right:5px;" name="b_start_h">
                          ...
                          ?>
                            <option value="<?php echo $h; ?>" <?php echo (date("h",strtotime($bannerData['b_start_date'])) == $h) ? "selected" : ""; ?>><?php echo $h."시"; ?></option>
                          <?php } ?>
                        </select>
                        <select class="form-control col-sm-1 float-left" name="b_start_m">
                            <option value="00" <?php echo (date("i",strtotime($bannerData['b_start_date'])) == "00") ? "selected" : ""; ?>>00분</option>
                            <option value="30" <?php echo (date("i",strtotime($bannerData['b_start_date'])) == "30") ? "selected" : ""; ?>>30분</option>
                        </select>
                        <label class="float-left">&nbsp;~&nbsp;</label>
                        <input type="text" class="form-control col-sm-1 date float-left" name="b_end_date" id="b_end_date" placeholder="yyyy-mm-dd" value="<?php echo date("Y-m-d",strtotime($bannerData['b_end_date'])); ?>"/>
                        <select class="form-control col-sm-1 float-left" style="margin-left:5px; margin-right:5px;" name="b_end_h">
                          ...
                          ?>
                            <option value="<?php echo $h; ?>" <?php echo (date("h",strtotime($bannerData['b_end_date'])) == $h) ? "selected" : ""; ?>><?php echo $h."시"; ?></option>
                          <?php } ?>
                        </select>
                        <select class="form-control col-sm-1 float-left" name="b_end_m">
                          <option value="00" <?php echo (date("i",strtotime($bannerData['b_end_date'])) == "00") ? "selected" : ""; ?>>00분</option>
                          <option value="30" <?php echo (date("i",strtotime($bannerData['b_end_date'])) == "30") ? "selected" : ""; ?>>30분</option>
                        </select>
                      </td>
                    </tr>
                    <tr class="top_tr">
                      ...
                      <td>
                        <?php if(!empty($bannerData['b_image'])){ ?>
                        <img src="{base_url}upload/banner/<?php echo $bannerData['b_image']; ?>" width="50" height="50" />
                        <?php } ?>
                        <input type="hidden" name="b_image_org" value="<?php echo $bannerData['b_image']; ?>" />
                    ...
                    <tr class="top_tr">
                      ...
                      <td>
                        <label style="margin-left:5px; margin-top:5px;">
                          <input type="radio" name="b_target" value="_self" <?php echo ($bannerData['b_target']=="_self") ? "checked" : "" ?>/> 본창
                        </label>
                        <label style="margin-left:5px; margin-top:5px;">
                          <input type="radio" name="b_target" value="_blank" <?php echo ($bannerData['b_target']=="_blank") ? "checked" : "" ?>/> 새창
                        </label>
                        <input type="text" class="form-control col-sm-4 float-left" name="b_link" id="b_link" value="<?php echo $bannerData['b_link']; ?>"/>
                      </td>
                    </tr>
                    <tr class="top_tr">
                      <th><small style="color:red">*</small> 노출순서</th>
                      <td>
                        <input type="text" class="form-control col-sm-4 float-left" name="sort_order" id="sort_order" value="<?php echo $bannerData['sort_order']; ?>"/>
                        숫자가 작을수록 앞에 노출됩니다.
                      </td>
                    </tr> 
                    <tr class="new_tr" style="display:none;">
                      ...
                      <td>
                        ...
                        <div class="row" id="new_choice_item">
                         <?php if(count($choiceProducts)>0 && $bannerData['view_location']=="new"){ ?>
                            <?php for($i = 0; $i < count($choiceProducts); $i++ ){ ?>
                            <div class="col-lg-3 justify-content-center text-center" id="hot_<?php echo $i;?>" data-names="<?php echo $choiceProducts[$i]['seq']; ?>">
                             <img src="/upload/product/<?php echo $choiceProducts[$i]['brand_seq']; ?>/<?php echo $choiceProducts[$i]['thumb_name']; ?>" style="width:100px;height:100px">
                             [<?php echo $choiceProducts[$i]['brand_name']; ?>]
                             <?php echo $choiceProducts[$i]['product_name']; ?> <a href='#' onclick='delHotProduct("<?php echo $i;?>","<?php echo $choiceProducts[$i]['seq']; ?>")'>[x]</a>
                            </div>
                            <?php } ?>
                          <?php } ?>
                        </div>
          ...
          <!-- /.card-body -->
              ...
              <div class="card-footer">
                ...
                <button type="button" class="btn btn-warning float-right" style="margin-right:10px;" onclick="deleteMainBanner('{seq}')">삭제</button>
...
$.datepicker.regional['ko'] = {
  ...
  $(function(){
    $('.date').datepicker({
      ...
      maxDate: ''
       ...
       <?php if($bannerData['view_location']=="new"){ ?>
           $('.top_tr').hide();
           $('.new_tr').show();
       <?php } ?>       
  ...
  function deleteMainBanner($seq)
  {
    if(confirm("정말 삭제 하시겠습니까?")){
      location.href = "/admin/deleteMainBanner/"+$seq;
    }
  }
  ...
  <?php if(count($choiceProducts)>0 && $bannerData['view_location'] == "week"){ ?>
    <?php for($i = 0; $i < count($choiceProducts); $i++ ){ ?>
      new_choice_item_arr[<?php echo $i; ?>] = "<?php echo $choiceProducts[$i]['seq']; ?>";
    <?php } ?>
  <?php } ?>
