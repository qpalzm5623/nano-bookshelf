...
<div class="content">
  ...
  <section class="content">
    <div class="container-fluid">
                        ...
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <th>계정상태</th>
                              <td >
                                <?php echo $data['user_status']=="Y"?"정상":"정지";?>
                              </td>
                            </tr>  
                            <tr>
                              <th>계약일</th>
                  ...
                  <p>* 북퀴즈 등록 내역 <span>총 {list_total} 개</span></p>
                  <div class="card card-primary">
                      <div class="card-body">
                          <table class="table table-hover">
                            ...
                            <thead>
                              <tr>
                                ...
                                <th class="text-center bg-lightgray">북퀴즈 승인 요청일</th>
                                <th class="text-center bg-lightgray">북퀴즈 최종 요청일</th>
                              </tr>
                            </thead>
                            <tbody>
                              ...
                              <tr  style="cursor:pointer">
                                <td class="text-center align-middle"><?php echo $row['book_name'];?></td>
                                <td class="text-center align-middle"><?php echo $row['reg_date'];?></td>
                                <td class="text-center align-middle"><?php echo $row['confirm_date'];?>
