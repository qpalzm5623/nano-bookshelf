                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th>* 소속명</th>
                      <td colspan="3">
                        <input type="text" class="form-control col-sm-6 float-left" id="group_name" name="group_name" placeholder="소속명" value="<?php echo @$data['group_name'];?>" required />
                      </td>
                    </tr>
                    <tr>
                      <th>* 이름</th>
                    ...
                    <tr>
                      <th>* 이용 상품</th>
                      <td colspan="3">
                        <select class="form-control col-sm-4 float-left" name="pricing_plan" id="pricing_plan">
                    ...
                    <tr>
                      <th>* 이용금액</th>
                      <td colspan="3">
                        <input type="text" class="form-control col-sm-6 float-left" id="pricing_price" name="pricing_price" placeholder="이용금액" value="<?php echo @$data['pricing_price'];?>" required />
                      </td>
                    </tr>
                    <tr>
                      <th>* 사업자번호</th>
                      <td colspan="3">
                        <input type="text" class="form-control col-sm-6 float-left" id="business_no" name="business_no" placeholder="사업자번호" value="<?php echo @$data['business_no'];?>" required  maxlength="10" />
                      </td>
                    </tr>                    
                    <tr>
                      <th>* 계약일</th>
                      <td colspan="3">
                        <input type="date" class="form-control col-sm-6 float-left date" id="start_date" name="start_date" value="<?php echo @$data['start_date'];?>" readonly required />
                      </td>
                    </tr>                    
                    <tr>
                      <th>* 만료일</th>
                      <td colspan="3">
                        <input type="date" class="form-control col-sm-6 float-left date" id="end_date" name="end_date" value="<?php echo @$data['end_date'];?>" readonly required />
                      </td>
                    </tr>
                    <tr>
                      <th>* 서비스 시작일</th>
                    ...
                    <tr>
                      <th>* 사용인원</th>
                      <td colspan="3">
                        <input type="text" class="form-control col-sm-6 float-left" id="use_count" name="use_count" placeholder="사용인원" value="<?php echo @$data['use_count'];?>"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
                      </td>
                    </tr>                    
                    <tr>
                      <th>* 마케팅 수신동의</th>
...
<script>
  ...
  function writeProc(){
      ...
      if(checkCorporateRegiNumber($('#business_no').val()) == false) {
        alert('사업자번호를 체크해주세요.');
        return;      
      }
