    ...
    <div class="card mb-12">
        <div class="card-body">
            ...
            <div class="row row-search">
                ...
                <div class="col-sm-8 row align-middle">
                    <input type="text" class="form-control col-6 float-right date hasDatepicker" style="margin:5px 5px 5px 5px;" name="keyword" id="keyword" value="<?php echo @$_REQUEST['keyword'];?>" placeholder="<?php if($this->session->userdata("admin_type") != "A" && ($this->session->userdata("admin_level") == "director" || $this->session->userdata("admin_level") == "teacher")){ echo "ID, 이름, 휴대폰번호를 입력해 주세요.";}else{echo "ID, 이름, 휴대폰번호를 입력해 주세요.";}?>">
          ...
          <div class="card">
                ...
                <div class="form-group">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <?php } else { ?>
                      <tr>
                        <td class="text-center" colspan="13">조회된 선생님이 없습니다.</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
            ...
            <div class="card-footer clearfix">
              ...
              <span class="float-right" style="margin-right:5px;">
                <button type="button" class="btn btn-block btn-warning" onclick="writeBtn()">등록</button>
              </span>
              <span class="float-right" style="margin-right:5px;">
...
<script>
  ...
  {
      location.href="teacher_write/"+$seq;
  }
  ...
  function writeBtn()
  {
    location.href="/admin/partner/teacher_write";
  }
