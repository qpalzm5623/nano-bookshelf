                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr style="display:none">
                      <th>* 주소</th>
                      <td colspan="3">
                        <input type="text" class="form-control col-sm-6 float-left" id="address" name="address" placeholder="주소" value="<?php echo @$data['address'];?>" />
                      </td>
                    </tr>    
                    <tr>
                      <th>반</th>
                      <td colspan="3">
                        <input type="hidden" class="form-control col-sm-6 float-left" id="class_name" name="class_name" placeholder="반" value="<?php echo @$data['class_name'];?>" required />
