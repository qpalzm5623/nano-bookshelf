        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <form role="form" id="admInfoForm">
              ...
              <input type="hidden" name="info_type" value="C"/>
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <th>링크 URL</th>
                      <td>
                        <input disabled type="text" class="form-control col-sm-4 float-left" id="info_manual" name="info_manual" placeholder="소리박스메뉴얼(PDF)" value="<?php echo $infoData['info_manual']; ?>" />
                      </td>
                    </tr>
                    <tr>
                      <th>타겟</th>
                      <td colspan="3">
                        <select class="form-control col-sm-3 float-left" name="manual_target" id="manual_target" disabled>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <th>링크 URL</th>
                      <td>
                        <input disabled type="text" class="form-control col-sm-4 float-left" id="info_movie" name="info_movie" placeholder="YOUTUBE 주소" value="<?php echo $infoData['info_movie']; ?>" />
                      </td>
                    </tr>
                    <tr>
                      <th>타겟</th>
                      <td colspan="3">
                        <select class="form-control col-sm-3 float-left" name="movie_target" id="movie_target" disabled>
...
<script>
  ...
  function writeInfo(){
    ...
    $.ajax({
      type: "POST",
      url : "/admin/academiAdm/infoWriteProc",
      data: formData,
      dataType:"json",
      processData: false,
      contentType: false,
      success : function(data, status, xhr) {
        if( data.result == "success" ){
          alert("저장 되었습니다.");
          location.href = "/admin/academiAdm/academiInfo";
        } else {
          alert("오류발생!!");
        }
      },
