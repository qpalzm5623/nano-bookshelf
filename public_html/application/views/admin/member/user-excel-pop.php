      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <!-- form start -->
            <form role="form" id="excelForm" enctype="multipart/form-data" action="/admin/member/memberExcelProc" method="POST">
...
{
    location.href="/assets/admin_resources/user_sample_1.xls";
}
