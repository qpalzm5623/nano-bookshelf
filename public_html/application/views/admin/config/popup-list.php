                ...
                <div class="form-group">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      {dataList}
                      <tr onclick="goView('{popup_id}')" style="cursor:pointer">
                        <td class="text-center">{count}</td>
                        <td class="text-center">{popup_title}</td>
...
<script>
  ...
  function goView($seq)
  {
      location.href="/admin/configAdm/popupWrite/"+$seq;
  }

  function writeBtn()
  {
    location.href="popupWrite";
  }
  ...
  function searchCourse()
  {
    ...
    location.href = "/admin/configAdm/popupList?srcN="+srcN+"&srcType="+srcType;
  }
</script>
