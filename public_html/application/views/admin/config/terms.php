  ...
  <section class="content">
    <div class="container-fluid">
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo $mode=="tomorrow"?"active":"";?>" id="custom-tabs-one-settings-tab" href="/admin/configAdm/terms/tomorrow" role="tab" aria-controls="custom-tabs-one-settings" aria-selected="false">내일배움카드 수강유의사항</a>
          </li>                    
        </ul>   
      <div class="row">
        <!-- left column -->
