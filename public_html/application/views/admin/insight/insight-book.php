                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr style="cursor:pointer">
                        ...
                        <td class="text-center align-middle">{quiz_use_cnt}</td>
                        <!--<td class="text-center align-middle"><button type="button" class="btn btn-block btn-success" onclick="viewDetail('{book_no}')">상세</button></td>-->
                      </tr>
                      {/list}
                      <?php } else { ?>
                      <tr>
                        <td class="text-center" colspan="3">조회된 서점이 없습니다.</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
