...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="{base_url}admin/main" class="brand-link text-center" style="background-color: #ffffff; padding: 10px 15px; display: flex; align-items: center; justify-content: center; height: 57px;">
