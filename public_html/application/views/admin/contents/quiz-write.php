            ...
            <!-- /.card-header -->
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    <th class="text-center align-middle bg-light" style="vertical-align:middle;">
                      <i class="fas fa-keyboard text-success mr-1"></i>국어&middot;독서<br/>특수문자
                    </th>
                    <td class="text-left align-middle">
                      <div class="card card-outline card-success mb-0">
                        <div class="card-body p-2" style="background:#fdfbf7;">
                          <div class="d-flex flex-wrap align-items-center mb-1 pb-1 border-bottom">
                            <span class="badge badge-warning text-dark mr-2 font-weight-bold">문장/인용부호</span>
                            <div class="btn-group mr-2">
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('『')">『 (겹낫표 시작)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('』')">』 (겹낫표 끝)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('「')">「 (홑낫표 시작)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('」')">」 (홑낫표 끝)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('“')">“ (큰따옴표)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('”')">”</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('‘')">‘ (작은따옴표)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('’')">’</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('…')">… (말줄임표)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('·')">&middot; (가운뎃점)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('~')">~ (물결)</button>
                            </div>
                          </div>

                          <div class="d-flex flex-wrap align-items-center mb-1">
                            <span class="badge badge-success mr-2 font-weight-bold">지문/빈칸기호</span>
                            <div class="btn-group mr-2">
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0 font-weight-bold" onclick="insertSymbol('㉠')">㉠</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0 font-weight-bold" onclick="insertSymbol('㉡')">㉡</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0 font-weight-bold" onclick="insertSymbol('㉢')">㉢</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0 font-weight-bold" onclick="insertSymbol('㉣')">㉣</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0 font-weight-bold" onclick="insertSymbol('㉤')">㉤</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('(가)')">(가)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('(나)')">(나)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('(다)')">(다)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('[  ]')">[ &nbsp; ] (네모빈칸)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('(  )')">( &nbsp; ) (괄호빈칸)</button>
                            </div>
                          </div>

                          <div class="d-flex flex-wrap align-items-center">
                            <span class="badge badge-info mr-2 font-weight-bold">문항/보기번호</span>
                            <div class="btn-group mr-2">
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0 font-weight-bold" onclick="insertSymbol('①')">①</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0 font-weight-bold" onclick="insertSymbol('②')">②</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0 font-weight-bold" onclick="insertSymbol('③')">③</button>
                            ...
                            <span class="badge badge-secondary mr-2 font-weight-bold">독서채점기호</span>
                            <div class="btn-group">
                              <button type="button" class="btn btn-sm btn-outline-success px-2 py-0 font-weight-bold" onclick="insertSymbol('○')">○ (맞음)</button>
                              <button type="button" class="btn btn-sm btn-outline-danger px-2 py-0 font-weight-bold" onclick="insertSymbol('✕')">✕ (틀림)</button>
                              <button type="button" class="btn btn-sm btn-outline-warning px-2 py-0 font-weight-bold" onclick="insertSymbol('△')">△ (세모)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('★')">★ (별표)</button>
                              <button type="button" class="btn btn-sm btn-outline-dark px-2 py-0" onclick="insertSymbol('※')">※ (참고표)</button>
                            </div>
                            <small class="text-muted ml-2 font-weight-bold">* 문제/보기 입력칸에 커서를 두고 버튼을 누르면 즉시 삽입됩니다.</small>
                          </div>
                        </div>
                      </div>
                    </td>
                              ...
                              <table class="table">
                                <tbody>
                                  <tr class="type1">
                                    ...
                                    <td class="text-center align-middle" >
                                      <input type="text" class="form-control col-sm-8" id="q_<?php echo $i; ?>" name="q[q][<?php echo $i; ?>]" value="<?php echo htmlspecialchars(@$quiz['q'][$i] ?? '', ENT_QUOTES, 'UTF-8');?>" required/>
                                    </td>
                                  </tr>
                                  <tr class="type1">
                                    <th class="text-center align-middle">
                                    ...
                                    <td class="text-left align-middle">
                                      ...
                                      <input type="text" class="form-control col-sm-8" id="q_<?php echo $i; ?>_img_data" name="q[img][<?php echo $i; ?>]"  value="<?php echo htmlspecialchars(@$quiz['img'][$i] ?? '', ENT_QUOTES, 'UTF-8');?>" style="display:none;width:100%" onblur="youtubeIframe(this,'<?php echo $i;?>')"/>
                                  ...
                                  <tr class="type1">
                                    ...
                                    <td class="text-center align-middle">
                                      ...
                                      <input type="text" class="form-control col-sm-8" id="q_<?php echo $i; ?>_a" name="q[a][<?php echo $i; ?>]"  value="<?php echo htmlspecialchars(@$quiz['a'][$i] ?? '', ENT_QUOTES, 'UTF-8');?>" onkeyup="chkValue(this, '<?php echo $i; ?>')" required/> 객관식의 정답은 숫자로 입력해주세요.
                                      </div>
                                    </td>
                                  </tr>
                                  <tr class="type1" id="q_<?php echo $i; ?>_choice">
                                    ...
                                    <td class="text-center align-middle">
                                      <div class="d-flex">
                                      1. <input type="text" class="form-control col-sm-8 mb-2" id="q_<?php echo $i; ?>_c1" name="q[c1][<?php echo $i; ?>]"  value="<?php echo htmlspecialchars(@$quiz['c1'][$i] ?? '', ENT_QUOTES, 'UTF-8');?>"/>
                                      </div>
                                      <div class="d-flex">
                                      2. <input type="text" class="form-control col-sm-8" id="q_<?php echo $i; ?>_c2" name="q[c2][<?php echo $i; ?>]"  value="<?php echo htmlspecialchars(@$quiz['c2'][$i] ?? '', ENT_QUOTES, 'UTF-8');?>"/>
                                      </div>
                                      <div class="d-flex">
                                      3. <input type="text" class="form-control col-sm-8" id="q_<?php echo $i; ?>_c3" name="q[c3][<?php echo $i; ?>]"  value="<?php echo htmlspecialchars(@$quiz['c3'][$i] ?? '', ENT_QUOTES, 'UTF-8');?>"/>
                                      </div>
                                      <div class="d-flex">
                                      4. <input type="text" class="form-control col-sm-8" id="q_<?php echo $i; ?>_c4" name="q[c4][<?php echo $i; ?>]"  value="<?php echo htmlspecialchars(@$quiz['c4'][$i] ?? '', ENT_QUOTES, 'UTF-8');?>"/>
                                      </div>
                                      <div class="d-flex">
                                      5. <input type="text" class="form-control col-sm-8" id="q_<?php echo $i; ?>_c5" name="q[c5][<?php echo $i; ?>]"  value="<?php echo htmlspecialchars(@$quiz['c5'][$i] ?? '', ENT_QUOTES, 'UTF-8');?>"/>
                                      </div>
                                    </td>
                                  </tr>
                                </tbody>
                              ...
                              <table class="table">
                                <tbody>
                                  <tr class="type1">
                                    ...
                                    <td class="text-center align-middle" >
                                      <input type="text" class="form-control col-sm-8" id="q_{i}" name="q[q][{i}]" required/>
                                    </td>
                                  </tr>
                                  <tr class="type1">
                                    <th class="text-center align-middle">
                                  ...
                                  <tr class="type1">
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="row" style="vertical-align:middle;line-height:35px;">
                                        <input type="text" class="form-control col-sm-8" id="q_{i}_a" name="q[a][{i}]" required onkeyup="chkValue(this, '{i}')"/> 객관식의 정답은 숫자로 입력해주세요.
                                        </div>
                                    </td>
                                  </tr>
...
var cnt = '<?php echo $quiz_cnt;?>';
    ...
    function chkValue(input, seq) {
        if($('#quiz_type1_'+seq).is(":checked") == true) {
            let value = $(input).val();
            
            // Check if the value is numeric
            if (!$.isNumeric(value)) {
                // If not numeric, clear the value and show an alert
                $(input).val('');
                alert('객관식의 정답은 숫자로 입력해주세요.');
                return;
            }
        }
    }
    ...
    // 수학 기호 및 특수문자 원클릭 입력 지원
    var lastActiveInput = null;
    $(document).on('focus', 'input[type="text"], textarea', function() {
        if ($(this).attr('id') && ($(this).attr('id').startsWith('q_') || $(this).attr('name').indexOf('q[') !== -1)) {
    ...
    function insertSymbol(sym) {
        if (!lastActiveInput) {
            // 활성화된 입력창이 없으면 첫번째 문제 입력창을 기본으로 선택
            lastActiveInput = document.querySelector('#quiz_list input[type="text"]');
        }
        if (!lastActiveInput) return;

        var start = lastActiveInput.selectionStart !== undefined ? lastActiveInput.selectionStart : lastActiveInput.value.length;
        var end = lastActiveInput.selectionEnd !== undefined ? lastActiveInput.selectionEnd : lastActiveInput.value.length;
        var text = lastActiveInput.value;

        lastActiveInput.value = text.substring(0, start) + sym + text.substring(end);
        lastActiveInput.focus();
        if (lastActiveInput.setSelectionRange) {
            var newPos = start + sym.length;
            lastActiveInput.setSelectionRange(newPos, newPos);
        }
    }
</script>