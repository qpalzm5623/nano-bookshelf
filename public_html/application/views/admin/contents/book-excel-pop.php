      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <!-- form start -->
            <form role="form" id="excelForm" enctype="multipart/form-data" action="/admin/content/bookExcelProc" method="POST">
...
{
    location.href="/assets/admin_resources/book_sample.xls";
}
