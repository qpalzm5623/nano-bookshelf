                  ...
                  <table class="table table-hover">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="text-center">인증 도서 권수</th>
                        <th class="text-center">북퀴즈 문항수</th>
                    ...
                    <tbody>
                      ...
                      <tr >
                        ...
                        <td class="text-center align-middle">{use_book_cnt}</td>
                        <td class="text-center align-middle">{use_quiz_cnt}</td>
                        <td class="text-center align-middle">{correct_cnt}</td>
                        <td class="text-center align-middle">{score}</td>
                        <td class="text-center align-middle"><button type="button" class="btn btn-block btn-warning" onclick="viewDetail('{user_id}')">상세 조회</button></td>
                      </tr>
                      {/list}
                      <?php } else { ?>
                      <tr>
                        <td class="text-center" colspan="7">조회된 퀴즈 이력이 없습니다.</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
...
<script>
  ...
  function viewDetail($user_id)
  {
      ...
      window.open("/admin/content/quiz_portfolio_pop/"+$user_id+"?searchTermType="+$('#searchTermTypeDate:checked').val()+"&startDate="+$('#startDate').val()+"&endDate="+$('#endDate').val()+"&keyword="+$('#keyword').val(), "_book_assign_pop", "width=1000, height=800, left=100, top=50"); 
  }  
</script>
