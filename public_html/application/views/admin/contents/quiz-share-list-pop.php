                  ...
                  <table class="table table-hover">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="text-center">공유제목</th>
                        <th class="text-center">도서명</th>
                        <th class="text-center">워크시트</th>
                        <th class="text-center">공유날짜</th>
                    ...
                    <tbody>
                      ...
                      <tr >
                        ...
                        <td class="text-center"><button type="button" class="btn  btn-primary" id="viewBtn" onclick="deleteData('{quiz_seq}','{book_no}','{share_user_id}')" >삭제</button>
                        ...
                        <input type="hidden" id="share_user_id{count}" value="{share_user_id}" />
