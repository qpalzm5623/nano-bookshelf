      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="card card-widget widget-user">
            ...
            <div class="widget-user-image">
              <button type="button" class="btn btn-default mt-4" onclick="location.href='/admin/insight/insightMemberDirector'">자세히 보기</button>
            </div>
            <div class="card-footer pt-4">
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $director['member_total']?></h5>
                ...
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $director['search_member_total']?></h5>
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $director['search_leave_member_total']?></h5>
        ...
        <div class="col-md-3">
          ...
          <div class="card card-widget widget-user">
            ...
            <div class="widget-user-image">
              <button type="button" class="btn btn-default mt-4" onclick="location.href='/admin/insight/insightMemberMaster'">자세히 보기</button>
            </div>
            <div class="card-footer pt-4">
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $master['member_total']?></h5>
                    <span class="description-text">총 회원</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                ...
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $master['search_member_total']?></h5>
                    <span class="description-text">신규 회원</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $master['search_leave_member_total']?></h5>
                    <span class="description-text">탈퇴 회원</span>
                  </div>
                  <!-- /.description-block -->
                </div>
        ...
        <div class="col-md-3">
          ...
          <div class="card card-widget widget-user">
            ...
            <div class="widget-user-image">
              <button type="button" class="btn btn-default mt-4" onclick="location.href='/admin/insight/insightMemberTeacher'">자세히 보기</button>
            </div>
            <div class="card-footer pt-4">
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $teacher['member_total']?></h5>
                    <span class="description-text">총 회원</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                ...
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $teacher['search_member_total']?></h5>
                    <span class="description-text">신규 회원</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                    <h5 class="description-header" style="font-size:24px;"><?php echo $teacher['search_leave_member_total']?></h5>
                    <span class="description-text">탈퇴 회원</span>
                  </div>
                  <!-- /.description-block -->
                </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                    ...
                    <span class="description-text">승인요청</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
        ...
        <div class="col-md-3">
          ...
          <div class="card card-widget widget-user">
            ...
            <div class="widget-user-image">
              <button type="button" class="btn btn-default mt-4" onclick="location.href='/admin/insight/insightRanking'">자세히 보기</button>
            </div>
            <div class="card-footer pt-4">
              <div >
