            ...
            <form role="form" id="boardWriteForm" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="book_title" id="book_title" placeholder="Enter Title" value="<?php echo $bookData['book_title']; ?>">
                </div>
                <div class="form-group">
                  <label for="title">PDF 등록</label>
                  <input type="file" class="form-control" name="book_file" id="book_file">
                  <small><?php echo $bookData['book_file']; ?></small>
                  <input type="hidden" class="form-control" name="book_file_org" value="<?php echo $bookData['book_file']; ?>">
                </div>
                <div class="form-group">
                  <label for="title">썸네일</label>
                  <input type="file" class="form-control" name="book_thumb" id="book_thumb">
                  <small><?php echo $bookData['book_thumb']; ?></small>
                  <input type="hidden" class="form-control" name="book_thumb_org" value="<?php echo $bookData['book_thumb']; ?>">
                </div>
              </div>
              <!-- /.card-body -->
...
<script>
  ...
  function goDelete(){
    if(confirm("삭제하시겠습니까?")){
      location.href="/admin/etcAdm/deleteBook/{book_seq}{param}";
    }
