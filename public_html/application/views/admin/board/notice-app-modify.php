            ...
            <form role="form" id="boardWriteForm" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="notice_title" id="notice_title" placeholder="제목을 입력해 주세요." value="<?php echo $noticeData['notice_title'] ?>">
                </div>
                <div class="form-group">
...
<script>
  function goList(){
    location.href="/admin/etc/noticeAppList{param}";
  }

  function goDelete(){
    if(confirm("삭제하시겠습니까?")){
      location.href="/admin/etc/deleteNoticeApp/{notice_seq}{param}";
    }
  ...
  function modifyProc(){
    ...
    $.ajax({
      type: "POST",
      url : "/admin/etc/noticeAppModifyProc",
      data: data,
      dataType:"json",
