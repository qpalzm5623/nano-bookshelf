			...
			<div class="full_popup bookquiz">
                ...
                <div class="popup_contents">
                    ...
                    for($i=1;$i<=$data['quiz_cnt'];$i++) {
                        ...
                        if($type[$i] =="C") {
                    ?>
                        <div class="quiz_form inner  <?php if($i >1) echo "hide";?>" id="quiz<?php echo $i;?>">
                            <!-- 문제-->
                            <div class="question">
                            ...
                            <div class="answer_area">
                                ...
                                <ul class="multiple_choice">
                                    ...
                                    <li class="answer_item">
                                        <input type="radio" id="c<?php echo $i?>_1" name="c[<?php echo $i;?>]" value="<?php echo $c1[$i];?>">
                                        <label for="c<?php echo $i?>_1"><?php echo $c1[$i];?></label>
                                    </li>
                                    <?php 
                                    }
                                    ?>
                                    ...
                                    ?>
                                    <li class="answer_item">
                                        <input type="radio" id="c<?php echo $i?>_2" name="c[<?php echo $i;?>]" value="<?php echo $c2[$i];?>">
                                        <label for="c<?php echo $i?>_2"><?php echo $c2[$i];?></label>
                                    </li>
                                    <?php 
                                    }
                                    ?>
                                    ...
                                    ?>
                                    <li class="answer_item">
                                        <input type="radio" id="c<?php echo $i?>_3" name="c[<?php echo $i;?>]"  value="<?php echo $c3[$i];?>">
                                        <label for="c<?php echo $i?>_3"><?php echo $c3[$i];?></label>
                                    </li>
                                    <?php 
                                    }
                                    ?>
                                    ...
                                    ?>
                                    <li class="answer_item">
                                        <input type="radio" id="c<?php echo $i?>_4" name="c[<?php echo $i;?>]"  value="<?php echo $c4[$i];?>">
                                        <label for="c<?php echo $i?>_4"><?php echo $c4[$i];?></label>
                                    </li>
                                    <?php 
                                    }
                                    ?>
                                    ...
                                    ?>
                                    <li class="answer_item">
                                        <input type="radio" id="c<?php echo $i?>_5" name="c[<?php echo $i;?>]"  value="<?php echo $c5[$i];?>">
                                        <label for="c<?php echo $i?>_5"><?php echo $c5[$i];?></label>
                                    </li>
                                    <?php 
                                    }
                                    ?>
